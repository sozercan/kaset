...
- ▶️ **[YouTube Mode](docs/youtube.md)** — Flip the sidebar source toggle for a native regular-YouTube client: recommendations, search, subscriptions, Watch Later, history, and video playback in a native watch view
