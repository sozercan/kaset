...
enum FoundationModelsPromptLibrary {
    ...
    static func commandBarInstructions(
        ...
        case .legacy26_0To26_3:
            ...
            user wants to empty the whole queue with no specific song mentioned. Use
            removeDuplicates for "remove duplicates" or "dedupe the queue".
        ...
        case .optimized26_4AndLater:
            ...
            Field rules:
            - action: play, queue, radio, search, inspectQueue, shuffle, clearQueue, removeFromQueue, removeDuplicates, like, dislike, skip, previous, pause, resume
            ...
            - remove duplicates, dedupe the queue -> removeDuplicates
            ...
            - "remove duplicates from the queue" -> removeDuplicates
