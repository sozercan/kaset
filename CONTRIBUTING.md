...
- [ ] Use test-only credentials for demo workflows.
- [ ] Work on a dedicated demo branch.
- [ ] Inspect the diff before pushing changes.
- [ ] Open a PR only after validation is complete.
